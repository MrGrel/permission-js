...
export type ConvertRecordValue<T extends AnyRecord> = T[string] extends [...T[string]]
  ? {
...
export type Rules<K extends string, A extends BaseActions<K>, C extends BaseConditions<K>> = {
  [key in K]: {
...
export type UnsubscribePermssions<
  Subjects extends string,
  Action extends BaseActions<Subjects>[Subjects],
  Conditions extends BaseConditions<Subjects>,
> = CheckPermissions<Subjects, Action, Conditions> & Required<PrevSignal>
